...
def hello():
    ...
    visits_per_day = request.args.get('visits_per_day')
    purchase_per_day = request.args.get('purchase_per_day')
    positive_comments = request.args.get('positive_comments')
    negative_comments = request.args.get('negative_comments')
    comments_per_day = request.args.get('comments_per_day')
    ret = model_2.predict_classes(numpy.array([[visits_per_day, purchase_per_day, positive_comments, negative_comments, comments_per_day], ]))[0][0]
    return str(ret)
